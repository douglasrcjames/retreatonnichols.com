...
import { georgiaOKeeffePhotos } from "../../photos";
import { Link } from 'react-router-dom'
import Background from '../../../assets/images/property-v2/gok.jpg';

var bgImgStyle = {
    width: "100%",
    height: "350px",
    backgroundImage: `url(${Background})`,
    backgroundPosition: "90% 50%", // change me around to move up and down!
    backgroundSize: "cover",
    paddingtop: "5%",
    overflow: "hidden"
  };

export default class GeorgiaOKeeffe extends Component {
    render() {
        return (
            <>
